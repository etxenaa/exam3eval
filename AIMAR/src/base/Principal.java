...
public class Principal {
	...
	/**
	 * coje la variable entera llamada nivel y mira si es menor que 50 o no
	 * @author Aimar
	 * @param nivel es el nivel del agua
	 * @return devuelve false si el nivel del agua es menor que 50 y devuelve true si el nivel del agua es igual o menor que 50
	 */
